...
var subscriberIds = ["01", "02", "03", "04"];

var dateOfBirths = ["02-01-1982", "03-06-1983", "11-25-1967", "08-11-1980"];
...
for (var i = 0; i < maxCounts; i++) {
    ...
    benefit.currentEligibleAmount = benefit.totalEligibleAmount - benefit.claimedAmount;
    ...
    var subscriber = {
        ...
        dependents: [
            {
                dependentId: subscriberIds[i] + "-01", dependentName: { firstName: firstNames[randomIdx], lastName: lastNames[randomIdx] },
                dependentDateOfBirth: new Date(dateOfBirths[randomIdx]),
                dependentAddress: addresses[randomIdx],
